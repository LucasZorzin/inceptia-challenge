                    ...
                    {results[0].map((nameClient) => (
                        <>
                            <tr key={nameClient.case_uuid}>
                                ...
                                <td as="li" className="col client"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-telephone-forward mx-3" viewBox="0 0 16 16">
...
</svg>{nameClient.case_duration}</td>
